    ...
    ReentrancyGuard
{
    ...
    string public contractURI =
        "ipfs://QmPT1Z3WtAbqiBZwbSFHFk2UE6VRh2JXVpUKp5RE8hC86T";
    string private hachiGenericMetaDataURI =
        "ipfs://QmbhqqnAxzqArd8nnAeR9bw52dWtLh2huKSqeJg2p1SrWG";
    ...
    uint256 public addressMintLimit = 3;
    uint256 public mintLimit = 8000;
    ...
    constructor(
        ...
        HachiWallet _wllt
    ) ERC1155(_ipfs) EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
        whtlst = _whtlst;
        wllt = _wllt;
     ...
     * Function is payable
     */
    function mintHachi(HachiTicket calldata _ticket)
        public
        payable
        whenNotPaused
        nonReentrant
    {
        ...
        require(
            numberMinted[_signer] + _length <= addressMintLimit,
     ...
     * @notice Only the contract owner can call this function. See {Ownable}.
     */
    function updateAddressMintLimit(uint256 _limit) public onlyOwner {
